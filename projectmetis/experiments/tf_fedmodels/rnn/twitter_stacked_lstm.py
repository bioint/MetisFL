...
from utils.languagemodels.language_models_ops import get_word_emb_arr, line_to_indices, val_to_vec


VOCAB_DIR = 'sent140/embs.json'


class LSTMTwitterSentimentFedModel(fedmodel.FedModelDef):

	def __init__(self, learning_rate, momentum, seq_len, num_classes, n_hidden, emb_arr=None):
