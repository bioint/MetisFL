...
################################################################################
# Functions for running training/evaluation/validation loops for the model.
################################################################################
...
def resnet_model_fn(features, labels, mode, model_class,
  ...
  Args:
    ...
    momentum: sgd_momentum term used for optimization
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
    ...
    # Create a tensor named initial_learning_rate for logging purposes
    tf.identity(learning_rate, name='initial_learning_rate')
    tf.summary.scalar('initial_learning_rate', learning_rate)
...
def resnet_main(
  ...
  Args:
    ...
    model_function: the function that instantiates the Model and builds the
      ops for train/evaluation. This will be passed directly into the estimator.
  ...
  for cycle_index in range(total_training_cycle):
    ...
    # evaluation (which is generally unimportant in those circumstances) to terminate.
    # Note that evaluation will run for max_train_steps each loop, regardless of the
    # global_step count.
