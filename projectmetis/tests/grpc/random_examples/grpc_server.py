...
class AsyncCollaborativeLearningServicer(async_collaborative_learning_no_cache_pb2_grpc.AsyncCollaborativeLearningServicer):
...
def serve():
	...
	async_collaborative_learning_no_cache_pb2_grpc.add_AsyncCollaborativeLearningServicer_to_server(
		AsyncCollaborativeLearningServicer(system_clients=_ALL_CLIENTS),
		server=server)
