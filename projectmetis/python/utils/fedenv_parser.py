...
class TerminationSignals(object):
	...
	def __init__(self, termination_signals_map):
		...
		self.execution_cutoff_time_mins = termination_signals_map.get("ExecutionCutoffTimeMins", 1e6)
		self.execution_cutoff_score = termination_signals_map.get("ExecutionCutoffScore", 1)
...
class ConnectionConfigs(object):
	...
	def __init__(self, connection_configs_map):
		self.device_type = connection_configs_map.get("DeviceType:", "linux")
...
class FederationEnvironment(object):
	...
	def __init__(self, federation_environment_config_fp):
		...
		self.communication_protocol = federation_environment.get("CommunicationProtocol")
