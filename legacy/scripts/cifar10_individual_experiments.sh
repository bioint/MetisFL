...
function run_synchronous_fedavg_homogeneous_clusters_experiments {
    ...
    for file in "${SYNCHRONOUS_CLUSTER_CONFIGURATION_FILES_DIRECTORY}"/FedAvg/*cifar10.cnn2.federation.10Learners.10Fast_atBDNF.SyncFedAvg*; do
        if [[ "${file}" == *"SyncFedAvg.run1.yaml"* ]]; then
            echo "Running" "${file}"
            /lfs1/stripeli/metiscondaenv/bin/python3 $PROJECT_HOME/experiments/run_fedmodels/cifar/cnn2/cifar10_cnn2_federated_main_sys_args.py --learning_rate 0.05 --momentum 0.75 --num_corrupted_learners $1 --corruption_level $2 --federation_environment_filepath "${file}" &
            sleep 1
        fi
        pids[${i}]=$!
    done
...
function run_asynchronous_fedavg_heterogeneous_clusters_experiments {
    ...
    # Synchronous FedAvg with x5 Fast and x5 Slow Learners
    for file in "${ASYNCHRONOUS_CLUSTER_CONFIGURATION_FILES_DIRECTORY}"/FedAvg/*cifar10.cnn2.federation.10Learners.5Fast_atBDNF_5Slow_atLEARN.AsyncFedAvg*; do
...
function run_synchronous_dvw_homogeneous_clusters_experiments {

    # Synchronous DVW with x10 Fast Learners
    for file in "${SYNCHRONOUS_CLUSTER_CONFIGURATION_FILES_DIRECTORY}"/DVW/*cifar10.cnn2.federation.10Learners.10Fast_atBDNF.SyncDVWMicroF1*; do
...
function run_synchronous_dvw_heterogeneous_clusters_experiments {
    ...
    for file in "${SYNCHRONOUS_CLUSTER_CONFIGURATION_FILES_DIRECTORY}"/DVW/*cifar10.cnn2.federation.10Learners.5Fast_atBDNF_5Slow_atLEARN.SyncDVWMicroF1*; do
        if [[ "${file}" == *"SyncDVWMicroF1.run1.yaml"* ]]; then
            echo "Running" "${file}"
            /lfs1/stripeli/metiscondaenv/bin/python3 $PROJECT_HOME/experiments/run_fedmodels/cifar/cnn2/cifar10_cnn2_federated_main_sys_args.py --learning_rate 0.05 --momentum 0.75 --federation_environment_filepath "${file}" &
            sleep 1
...
function run_asynchronous_dvw_heterogeneous_clusters_experiments {
    ...
    # Synchronous DVW with x5 Fast and x5 Slow Learners
    for file in "${ASYNCHRONOUS_CLUSTER_CONFIGURATION_FILES_DIRECTORY}"/DVW/*cifar10.cnn2.federation.10Learners.5Fast_atBDNF_5Slow_atLEARN.AsyncDVWMicroF1*; do
...
#run_synchronous_fedavg_homogeneous_clusters_experiments 1 2
#run_synchronous_fedavg_homogeneous_clusters_experiments 3 2
#run_synchronous_fedavg_homogeneous_clusters_experiments 5 2
#run_synchronous_fedavg_heterogeneous_clusters_experiments
#run_asynchronous_fedavg_heterogeneous_clusters_experiments
#run_synchronous_dvw_homogeneous_clusters_experiments 0 0
#run_synchronous_dvw_homogeneous_clusters_experiments 1 2
#run_synchronous_dvw_homogeneous_clusters_experiments 3 2
#run_synchronous_dvw_homogeneous_clusters_experiments 5 2
#run_synchronous_dvw_heterogeneous_clusters_experiments
...
#run_synchronous_fedavg_homogeneous_clusters_experiments
#run_synchronous_fedavg_heterogeneous_clusters_experiments
#run_asynchronous_fedavg_heterogeneous_clusters_experiments
#run_synchronous_dvw_homogeneous_clusters_experiments
#run_synchronous_dvw_heterogeneous_clusters_experiments
...
#run_synchronous_fedavg_homogeneous_clusters_experiments
#run_synchronous_fedavg_homogeneous_clusters_experiments 1 1
#run_synchronous_fedavg_homogeneous_clusters_experiments 3 1
#run_synchronous_fedavg_homogeneous_clusters_experiments 5 1
#run_asynchronous_fedavg_heterogeneous_clusters_experiments
#run_synchronous_dvw_homogeneous_clusters_experiments 0 0
#run_synchronous_dvw_homogeneous_clusters_experiments 1 1
#run_synchronous_dvw_homogeneous_clusters_experiments 3 1
#run_synchronous_dvw_homogeneous_clusters_experiments 5 1
#run_synchronous_fedavg_heterogeneous_clusters_experiments
#run_asynchronous_fedavg_heterogeneous_clusters_experiments
#run_synchronous_dvw_homogeneous_clusters_experiments
#run_synchronous_dvw_heterogeneous_clusters_experiments
...
#run_synchronous_fedavg_homogeneous_clusters_experiments
#run_synchronous_fedavg_heterogeneous_clusters_experiments 0.025
#run_asynchronous_fedavg_heterogeneous_clusters_experiments
#run_synchronous_dvw_homogeneous_clusters_experiments
#run_synchronous_dvw_heterogeneous_clusters_experiments
...
export SEMI_SYNCHRONOUS_EXECUTION="False"
export SEMI_SYNCHRONOUS_K_VALUE=2
export GPU_TIME_PER_BATCH=30
export CPU_TIME_PER_BATCH=300

#run_synchronous_fedavg_homogeneous_clusters_experiments
#run_synchronous_fedavg_heterogeneous_clusters_experiments 0.05
#run_asynchronous_fedavg_heterogeneous_clusters_experiments
#run_synchronous_dvw_homogeneous_clusters_experiments
#run_synchronous_dvw_heterogeneous_clusters_experiments
...
#run_synchronous_fedavg_homogeneous_clusters_experiments 0.025
run_synchronous_fedavg_heterogeneous_clusters_experiments
#run_asynchronous_fedavg_heterogeneous_clusters_experiments
#run_synchronous_dvw_homogeneous_clusters_experiments
#run_synchronous_dvw_heterogeneous_clusters_experiments
