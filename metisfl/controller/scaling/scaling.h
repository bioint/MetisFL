...
absl::flat_hash_map<std::string, double> GetDatasetScalingFactors(
  ...
  for (const auto &[learner_id, num_examples] : num_training_examples) {
    scaling_factors[learner_id] = static_cast<double>(num_examples) /
...
absl::flat_hash_map<std::string, double> GetParticipantsScalingFactors(
...
absl::flat_hash_map<std::string, double> GetBatchesScalingFactors(
