...
#ifndef METISFL_METISFL_CONTROLLER_AGGREGATION_MODEL_AGGREGATION_H_
#define METISFL_METISFL_CONTROLLER_AGGREGATION_MODEL_AGGREGATION_H_
...
#endif //METISFL_METISFL_CONTROLLER_AGGREGATION_MODEL_AGGREGATION_H_
