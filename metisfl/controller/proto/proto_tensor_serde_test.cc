...
TEST_F(ProtoTensorSerDe, DeSerUINT16) /* NOLINT */ {
  auto tensor_uint16 = ParseTextOrDie<projectmetis::TensorSpec>(kTensor_1to10_as_UINT16);
  ...
  // Deserialize the serialized values to validate equality with original tensor.
  ...
  std::memcpy(&deserialized_tensor_aux[0], serialized_tensor_str.c_str(), num_values * sizeof(unsigned short));
...
TEST_F(ProtoTensorSerDe, DeSerINT32) /* NOLINT */ {
  auto tensor_int32 = ParseTextOrDie<projectmetis::TensorSpec>(kTensor_1to10_as_INT32);
  ...
  std::memcpy(&deserialized_tensor_aux[0], serialized_tensor_str.c_str(), num_values * sizeof(signed int));
...
TEST_F(ProtoTensorSerDe, DeSerFLOAT32) /* NOLINT */ {
  auto tensor_float32 = ParseTextOrDie<projectmetis::TensorSpec>(kTensor_1to10_as_FLOAT32);
  ...
  std::memcpy(&deserialized_tensor_aux[0], serialized_tensor_str.c_str(), num_values * sizeof(float));
...
TEST_F(ProtoTensorSerDe, DeSerFLOAT64) /* NOLINT */ {
  auto tensor_float64 = ParseTextOrDie<projectmetis::TensorSpec>(kTensor_1to10_as_FLOAT64);
  ...
  std::memcpy(&deserialized_tensor_aux[0], serialized_tensor_str.c_str(), num_values * sizeof(double));
