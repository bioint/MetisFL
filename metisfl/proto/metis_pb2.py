...
_HYPERPARAMETERS.fields_by_name['optimizer'].message_type = metisfl_dot_proto_dot_model__pb2._OPTIMIZERCONFIG
_CONTROLLERPARAMS_MODELHYPERPARAMS.fields_by_name['optimizer'].message_type = metisfl_dot_proto_dot_model__pb2._OPTIMIZERCONFIG
